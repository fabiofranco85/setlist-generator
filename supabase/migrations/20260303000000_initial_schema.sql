...
-- ---------------------------------------------------------------------------
-- 1b. Helper: set_org_context RPC for RLS policies
-- ---------------------------------------------------------------------------
-- Called by the application layer to set the current org context on each
-- connection.  RLS policies reference current_setting('app.org_id', true).
